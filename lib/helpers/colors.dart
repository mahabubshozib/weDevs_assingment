...
Color SCAFFOLD_BACKGROUND = const Color(0xffE5E5E5);
Color WHITE = const Color(0xffFFFFFF);
Color PRIMARY_COLOR = const Color(0xffF75F55);
Color PRIMARY_LIGHT_COLOR = const Color(0xffFF708A);
Color BLACK = const Color(0xff000000);
Color GREY= const Color(0xffA4A9AF);
